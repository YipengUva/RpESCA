...
# test GGB simulation
test_results_GGB <- test_dataSimu_group(n=n, ds=ds,
                                        dataTypes = 'GGB')
expect_true(all(unlist(test_results_GGB)))

# test GBB simulation
test_results_GBB <- test_dataSimu_group(n=n, ds=ds,
                                        dataTypes = 'GBB')
...
## testing data simulation only with element-wise sparsity
# test GGG simulation
...
# test GGB simulation
test_results_GGB <- test_dataSimu_element(n=n, ds=ds, R=3,
                                        dataTypes = 'GGB')
expect_true(all(unlist(test_results_GGB)))

# test GBB simulation
test_results_GBB <- test_dataSimu_element(n=n, ds=ds, R=3,
                                        dataTypes = 'GBB')
expect_true(all(unlist(test_results_GBB)))
