...
#' }
update_B_L2 <- function(JHk,A,B0,Sigmas0,d,
                        fun_concave,alphas,rhos,lambdas,gamma){
  sumd <- sum(d)
  nDataSets <- length(d)
  n <- dim(A)[1]
...
#'                    fun_concave,alphas,rhos,lambdas,gamma)
#' }
update_B_L1 <- function(JHk,A,B0,Sigmas0,d,
                        fun_concave,alphas,rhos,lambdas,gamma){
  sumd <- sum(d)
  nDataSets <- length(d)
  n <- dim(A)[1]
...
#'                    fun_concave,alphas,rhos,lambdas,gamma)
#' }
update_B_composite <- function(JHk,A,B0,Sigmas0,d,
                        fun_concave,alphas,rhos,lambdas,gamma){
  sumd <- sum(d)
  nDataSets <- length(d)
  n <- dim(A)[1]
...
#'                    fun_concave,alphas,rhos,lambdas,gamma)
#' }
update_B_element <- function(JHk,A,B0,Sigmas0,d,
                        fun_concave,alphas,rhos,lambdas,gamma){
  sumd <- sum(d)
  nDataSets <- length(d)
  n <- dim(A)[1]
